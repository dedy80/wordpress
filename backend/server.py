...
SEED_REVIEWS = [
    {"author_name": "Rani Puspita", "rating": 5, "text": "Materinya lengkap dan pengajarnya sabar. Sekarang saya jauh lebih mahir pakai Excel untuk kerja.", "relative_time": "2 minggu lalu"},
    {"author_name": "Ahmad Fauzi", "rating": 5, "text": "Ikut kelas Digital Marketing & BNSP, langsung dapat sertifikat resmi. Sangat direkomendasikan!", "relative_time": "1 bulan lalu"},
    {"author_name": "Dewi Lestari", "rating": 5, "text": "Suasana belajar nyaman, fasilitas oke, dan admin responsif. Terima kasih LKP HReDU.", "relative_time": "1 bulan lalu"},
    {"author_name": "Bagus Prakoso", "rating": 4, "text": "Kursus Ms Office-nya bagus, praktik langsung banyak. Cocok buat pemula.", "relative_time": "3 minggu lalu"},
    {"author_name": "Siti Nurhaliza", "rating": 5, "text": "Pelatihan singkat tapi padat ilmu. Pengajar profesional dan ramah.", "relative_time": "2 bulan lalu"},
]
...
async def seed_data():
    if await db.certificates.count_documents({}) == 0:
        cert = Certificate(
            nomor_sertifikat="HRDU/2026/0001",
            nama_peserta="Budi Santoso",
            program="Digital Marketing & Sertifikasi BNSP",
            tanggal_terbit="2026-01-10",
            predikat="Sangat Baik",
            status="Valid",
        )
        await db.certificates.insert_one(cert.model_dump())
        logger.info("Seeded default certificate")
